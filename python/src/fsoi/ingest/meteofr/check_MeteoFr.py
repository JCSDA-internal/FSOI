...
def parse_date(datadir, adate):
    ...
    old_platform_names = ['aircraft', 'buoy', 'gpsro', 'pilot', 'satem_airs', 'satem_amsua',
                          'satem_amsub', 'satem_atms', 'satem_cris', 'satem_goesimg', 'satem_hirs',
                          'satem_iasi',
                          'satem_mhs', 'satem_seviri', 'satem_ssmis', 'satwind', 'scatt',
                          'synop_gpssol', 'synop_insitu',
                          'temp']
...
def main():
    ...
    parser.add_argument('-b', '--begin_date', help='dataset begin date', type=str,
                        default='2014120100', required=False)
    parser.add_argument('-e', '--end_date', help='dataset end date', type=str, default='2015022818',
                        required=False)
    ...
    ax = dfm['TotImp'].plot(kind='barh', xerr=dfs, width=1., alpha=0.6,
                            title='Meteo France Total Impact')
