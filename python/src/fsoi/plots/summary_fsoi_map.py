...
plotOpt = loi.getPlotOpt('TotImp',cycle=cycle,center=center,savefigure=savefig,platform=platform,domain=None)
...
sc = bmap.scatter(x,y,c=imps,s=20,marker='s',cmap=cmap,alpha=1.0,edgecolors='face',vmin=-cmax,vmax=cmax)
