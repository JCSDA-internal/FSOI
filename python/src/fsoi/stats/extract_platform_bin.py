...
if __name__ == '__main__':
    ...
    parser.add_argument('--rootdir', help='root path to directory', type=str,
                        ...
                        required=False)
    parser.add_argument('--begin_date', help='dataset begin date', type=str, default='2014120100',
                        required=False)
    parser.add_argument('--end_date', help='dataset end date', type=str, default='2015022818',
                        required=False)
    parser.add_argument('--interval', help='dataset interval', type=int, default=6, required=False)
    parser.add_argument('--dlat', help='latitude box in degrees', type=float, default=5.0,
                        required=False)
    parser.add_argument('--dlon', help='longitude box in degrees', type=float, default=5.0,
                        required=False)
