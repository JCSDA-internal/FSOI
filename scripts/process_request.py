"""
This module will process a given request:  1) download
H5 files from S3 and; 2) create plots using other modules.
"""
...
def process_request(raw_request):
    ...
    :param raw_request: Contains all of the request details (not validated)
...
if __name__ == '__main__':
    ...
    global_response = process_request(global_request)
